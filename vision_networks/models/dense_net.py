...
class DenseNet:
	def __init__(self, data_provider, growth_rate, depth,
		...
		self.label_length = data_provider.label_length
		self.depth = depth
	...
	def trainsition_layer_to_classes(self, _input):
		...
		W = self.weight_variable_xavier(
			[features_total, self.label_length], name='W')
		bias = self.bias_variable([self.label_length])
